...
// Make piper available globally for the app
window.piper = {};
...
// Initialize piper globally when the module loads
window.piper = {
  setVoice: setVoice,
  textToWavAudio: textToWavAudio,
  textToFloat32Audio: textToFloat32Audio
};
